...
# knitr::opts_knit$set(root.dir = '/Users/cgu3/Documents/missing-protein-project')
...
gastric_nsaf <- as.matrix(read.csv(paste0(gastric_data_path, 'gastric_primary_cell_nsaf.csv'), row.names = 1))
...
missing_protein_df <- read_csv('gastric-primary-cell/FDR1_distinct2_pep/nextprot_missing_protein.csv')
# missing_protein_df$Accession <- str_remove(missing_protein_df$`acc. code`, 'NX_')
```
...
dict_accession_to_gene_symbol <- read_csv('gastric-primary-cell/FDR1_distinct2_pep/id_mapping_table.csv')
```
